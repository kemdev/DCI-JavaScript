 ...
 * The AttackSkill method should take in three arguments: the name of the attack, the amount of damage the attack does, and the amount of magic the attack requires. 
 ...
 * This is its most important method! Consider all the possiblites in this method. (e.g what if the pokemon doesn't have enough magic to launch the attack skill?). 
 ...
 *  The attack method should additionally console.log out whether the attack was successful (in other words, whether the attacking pokemon had enough magic to actually carry out the attack), 
 * and the result of the attack. The attack method should take in two arguments: the index (or key) of the attack to be used, and the Pokemon object that needs to be attacked. 
 ...
 * You should create a constructor function to create a pokemon, and then add the methods onto the .prototype property of the constructor function. 
 * You should then use that constructor function to create all new pokemon.
...
class Pokemon {
    ...
    attack(index, target) {
        ...
        if (attack.magic > this.magic) {
            console.log(`${this.name} doesn't have enough magic to attack!`)
            return
        }
        this.magic -= attack.magic
        target.health -= attack.damage
        console.log(`${this.name} attacked ${target.name} with ${attack.name}!`)
